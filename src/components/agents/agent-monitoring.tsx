...
function JsonBlock({ value }: { value: unknown }) {
  ...
  return (
    <pre className="max-h-80 overflow-auto rounded-[8px] border border-[#27272a] bg-[#050505] p-3 font-mono text-[11px] leading-relaxed text-[#d4d4d8] whitespace-pre-wrap break-words">
      {text}
    </pre>
  );
}
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 space-y-5 overflow-y-auto p-4">
        ...
        {reasoning ? (
          ...
          >
            <pre className="max-h-64 overflow-auto rounded-[8px] border border-[#27272a] bg-[#050505] p-3 text-[12px] leading-relaxed whitespace-pre-wrap break-words text-[#c4b5fd]">
              {reasoning}
            </pre>
          </Section>
        ) : (
  ...
  return (
    <div className="flex h-[calc(100vh-0px)] flex-col">
      ...
      <div className="flex min-h-0 flex-1">
        {/* Agent selector */}
        <aside className="w-56 shrink-0 overflow-y-auto border-r border-[#27272a] bg-[#050505]">
